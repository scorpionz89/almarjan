				...
				<div id="redux-add-widget" class="widgets-holder-wrap">
					<div class="">
						...
						<div class="sidebar-name">
							<h3><?php echo esc_html__( 'Create Widget Area', 'bighearts-core' ); ?> <span class="spinner"></span></h3>
						</div>
							...
							<form id="addWidgetAreaForm" action="" method="post">
								...
								<div class="widget-content">
									<input
											...
											class="regular-text"
											title="<?php echo esc_attr__( 'Name', 'bighearts-core' ); ?>"
											placeholder="<?php echo esc_attr__( 'Name', 'bighearts-core' ); ?>"/>
								</div>
								<div class="widget-control-actions">
									<div class="aligncenter">
										<input
												...
												type="submit"
												value="<?php echo esc_attr__( 'Create Widget Area', 'bighearts-core' ); ?>"/>
									</div>
									<br class="clear">
								</div>
							</form>
		...
		public function enqueue() {
			...
			wp_localize_script(
				...
				array(
					...
					'delete'  => esc_html__( 'Delete', 'bighearts-core' ),
					'confirm' => esc_html__( 'Confirm', 'bighearts-core' ),
					'cancel'  => esc_html__( 'Cancel', 'bighearts-core' ),
				)
			);
		}
	}
