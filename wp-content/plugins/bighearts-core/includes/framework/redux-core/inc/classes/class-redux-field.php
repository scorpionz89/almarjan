...
if ( ! class_exists( 'Redux_Field', false ) ) {
	...
	abstract class Redux_Field {
		...
		public static function make_base_descriptor(): Redux_Descriptor {
			...
			$d->add_field( 'id', __( 'Field ID', 'bighearts-core' ), RDT::TEXT )->set_order( 0 )->set_required();
			$d->add_field( 'title', __( 'Title', 'bighearts-core' ), RDT::TEXT )->set_order( 1 );
			$d->add_field( 'subtitle', __( 'Subtitle', 'bighearts-core' ), RDT::TEXT )->set_order( 2 );
			$d->add_field( 'desc', __( 'Description', 'bighearts-core' ), RDT::TEXT )->set_order( 3 );
			$d->add_field( 'class', __( 'Class', 'bighearts-core' ), RDT::TEXT )->set_order( 3 );
			$d->add_field( 'compiler', __( 'Compiler', 'bighearts-core' ), RDT::BOOL, '', false )->set_order( 60 );
			$d->add_field( 'default', __( 'Default', 'bighearts-core' ), RDT::OPTIONS, '', false )->set_order( 60 );
			$d->add_field( 'disabled', __( 'Disabled', 'bighearts-core' ), RDT::BOOL, '', false )->set_order( 60 );
			$d->add_field( 'hint', __( 'Hint', 'bighearts-core' ), RDT::OPTIONS, '', false )->set_order( 60 );
			$d->add_field( 'hint', __( 'Permissions', 'bighearts-core' ), RDT::OPTIONS, '', false )->set_order( 60 );
			$d->add_field( 'required', __( 'Required', 'bighearts-core' ), RDT::BOOL, '', false )->set_order( 60 );
