...
if ( ! class_exists( 'Redux_Welcome', false ) ) {
	...
	class Redux_Welcome {
		...
		public function do_redirect() {
			if ( ! defined( 'WP_CLI' ) ) {
				wp_safe_redirect( esc_url( admin_url( add_query_arg( array( 'page' => 'bighearts-core' ), 'options-general.php' ) ) ) );
				exit();
			}
		}
		...
		public function change_wp_footer() {
			echo esc_html__( 'If you like', 'bighearts-core' ) . ' <strong>Redux</strong> ' . esc_html__( 'please leave us a', 'bighearts-core' ) . ' <a href="https://wordpress.org/support/view/plugin-reviews/redux-framework?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> ' . esc_html__( 'rating. A huge thank you in advance!', 'bighearts-core' );
		}
		...
		public function admin_menus() {
			...
			// About Page.
			$page( esc_html__( 'What is Redux Framework?', 'bighearts-core' ), esc_html__( 'Redux', 'bighearts-core' ), $this->minimum_capability, 'redux-framework', array( $this, 'about_screen' ) );
		}
		...
		public function tabs() {
			...
			<h2 class="nav-tab-wrapper">
				<a
					...
					href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'bighearts-core' ), 'options-general.php' ) ) ); ?>">
					<?php esc_attr_e( 'What is Redux?', 'bighearts-core' ); ?>
				</a>
			</h2>
			<?php
		}
			...
			<p class="redux-actions">
				...
				if ( $options['demo'] ) {
					...
					<a
						...
						class=" button-text button-demo"><?php echo esc_html__( 'Disable Panel Demo', 'bighearts-core' ); ?></a>
					<?php
				} else {
					?>
					<a
						href="<?php echo esc_url( admin_url( add_query_arg( $query_args, 'options-general.php' ) ) ); ?>"
						class=" button-text button-demo active"><?php echo esc_html__( 'Enable Panel Demo', 'bighearts-core' ); ?></a>
					<?php
				}
