		...
		public function render() {
			...
			if ( true === $this->field['background-repeat'] ) {
				$array = array(
					...
					'repeat'    => esc_html__( 'Repeat All', 'bighearts-core' ),
					'repeat-x'  => esc_html__( 'Repeat Horizontally', 'bighearts-core' ),
					'repeat-y'  => esc_html__( 'Repeat Vertically', 'bighearts-core' ),
					'inherit'   => esc_html__( 'Inherit', 'bighearts-core' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-repeat-select" data-placeholder="' . esc_html__( 'Background Repeat', 'bighearts-core' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-repeat]" class="redux-select-item redux-background-input redux-background-repeat ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-clip'] ) {
				$array = array(
					'inherit'     => esc_html__( 'Inherit', 'bighearts-core' ),
					'border-box'  => esc_html__( 'Border Box', 'bighearts-core' ),
					'content-box' => esc_html__( 'Content Box', 'bighearts-core' ),
					'padding-box' => esc_html__( 'Padding Box', 'bighearts-core' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-clip-select" data-placeholder="' . esc_html__( 'Background Clip', 'bighearts-core' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-clip]" class="redux-select-item redux-background-input redux-background-clip ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-size'] ) {
				...
				echo '<select id="' . esc_attr( $this->field['id'] ) . '-size-select" data-placeholder="' . esc_html__( 'Background Size', 'bighearts-core' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-size]" class="redux-select-item redux-background-input redux-background-size ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-position'] ) {
				$array = array(
					'left top'      => esc_html__( 'Left Top', 'bighearts-core' ),
					'left center'   => esc_html__( 'Left center', 'bighearts-core' ),
					'left bottom'   => esc_html__( 'Left Bottom', 'bighearts-core' ),
					'center top'    => esc_html__( 'Center Top', 'bighearts-core' ),
					'center center' => esc_html__( 'Center Center', 'bighearts-core' ),
					'center bottom' => esc_html__( 'Center Bottom', 'bighearts-core' ),
					'right top'     => esc_html__( 'Right Top', 'bighearts-core' ),
					'right center'  => esc_html__( 'Right center', 'bighearts-core' ),
					'right bottom'  => esc_html__( 'Right Bottom', 'bighearts-core' ),
				);
			...
			if ( $this->field['background-image'] ) {
				...
				$placeholder = $this->field['placeholder'] ?? esc_html__( 'No media selected', 'bighearts-core' );
				...
				echo '<span class="button redux-background-upload" id="' . esc_attr( $this->field['id'] ) . '-media">' . esc_html__( 'Upload', 'bighearts-core' ) . '</span>';
				...
				echo '<span class="button removeCSS redux-remove-background' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $this->field['id'] ) . '" rel="' . esc_attr( $this->field['id'] ) . '">' . esc_html__( 'Remove', 'bighearts-core' ) . '</span>';
