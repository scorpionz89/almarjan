	...
	<div class="siteseo-dashboard-columns">
		...
		<div class="siteseo-dashboard-column siteseo-dashboard-column-right">
			...
			<div id="notice-support" class="siteseo-notice-card">
				...
				<p class="siteseo-card-actions">
					<a id="tweet" class="btn btnSecondary" href="https://twitter.com/intent/tweet?text=Supercharge your website with our SEO plugin. Boost rankings, attract traffic, and dominate the competition. Elevate your SEO game!&hashtags=SiteSEO,SEO,plugin" target="_blank"><?php esc_html_e('Tweet'); ?></a>
				</p>
			</div>
		</div>
	</div>
